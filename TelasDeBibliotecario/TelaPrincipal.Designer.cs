namespace Pim3_2025.TelasDeBibliotecario
{
    partial class TelaPrincipal
    {
        ...
        private void InitializeComponent()
        {
            ...
            label9 = new Label();
            label8 = new Label();
            lblSuspenderRetomarLivros = new Label();
            lblSuspenderRetomarCliente = new Label();
            lnlLivrosCadastrados = new Label();
            ...
            panel2.Controls.Add(lblSuspenderRetomarLivros);
            panel2.Controls.Add(lblSuspenderRetomarCliente);
            panel2.Controls.Add(lnlLivrosCadastrados);
            ...
            label11.Location = new Point(4, 546);
            ...
            // 
            // lblSuspenderRetomarLivros
            // 
            lblSuspenderRetomarLivros.AutoSize = true;
            lblSuspenderRetomarLivros.Font = new Font("Segoe UI", 13.8F, FontStyle.Bold);
            lblSuspenderRetomarLivros.ForeColor = Color.White;
            lblSuspenderRetomarLivros.Location = new Point(19, 307);
            lblSuspenderRetomarLivros.Name = "lblSuspenderRetomarLivros";
            lblSuspenderRetomarLivros.Size = new Size(227, 62);
            lblSuspenderRetomarLivros.TabIndex = 11;
            lblSuspenderRetomarLivros.Text = "Suspender/Retomar\r\n            Livro";
            // 
            ...
            lblSuspenderRetomarCliente.Location = new Point(16, 213);
            lblSuspenderRetomarCliente.Name = "lblSuspenderRetomarCliente";
            lblSuspenderRetomarCliente.Size = new Size(233, 62);
            lblSuspenderRetomarCliente.TabIndex = 10;
            lblSuspenderRetomarCliente.Text = "Suspender/Retomar \r\n          Cliente";
            // 
            // lnlLivrosCadastrados
            // 
            lnlLivrosCadastrados.AutoSize = true;
            lnlLivrosCadastrados.Font = new Font("Segoe UI", 13.8F, FontStyle.Bold);
            lnlLivrosCadastrados.ForeColor = Color.White;
            lnlLivrosCadastrados.Location = new Point(19, 123);
            lnlLivrosCadastrados.Name = "lnlLivrosCadastrados";
            lnlLivrosCadastrados.Size = new Size(214, 31);
            lnlLivrosCadastrados.TabIndex = 9;
            lnlLivrosCadastrados.Text = "Livros Cadastrados";
            // 
        ...
        private Label lnlLivrosCadastrados;
        private Label lblClientesCadastrados;
        private Label lblSuspenderRetomarLivros;
